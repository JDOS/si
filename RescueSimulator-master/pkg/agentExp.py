...
class AgentExp:
    ...
    def deliberate(self):
        ...
        print("anterior:", self.currentState)
        print("atual:", self.previousAction)
        print("gps", self.positionSensor())
        self.plan.setResult(self.currentState,self.previousAction, self.positionSensor())

        self.plan.removeUntried(self.previousAction,self.currentState)
